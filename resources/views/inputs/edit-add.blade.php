<li class="dd-item" data-id="{{ $input->id }}" id="input-id-{{ $input->id }}">
    ...
    <div class="panel panel-bordered panel-info">
        ...
        <div class="panel-body">
            <form role="form" action="{{ route('versatile.inputs.update', $input->id) }}"
                    method="POST"
            ...
            <form method="POST" action="{{ route('versatile.inputs.destroy', $input->id) }}">
                {{ method_field("DELETE") }}
                ...
                <span class="btn-group-xs">
                    ...
                    >{{ __('versatile::generic.delete') }} This Input</button>
                </span>
            </form>
        </div> <!-- /.panel-body -->
    </div> <!-- /.panel -->
