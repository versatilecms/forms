...
namespace Versatile\Forms\Mail;
...
class Enquiry extends Mailable
{
    ...
    {
        if (!View::exists('versatile-forms::email-templates.' . $this->form->email_template)) {
        ...
        return $this->from($this->form->mailfrom, $this->form->mailfromname)
            ...
            ->view('versatile-forms::email-templates.' . $this->form->email_template);
    }
}
